 ...
 * densa (`_tabela-densa.scss`), com ordenação por cabeçalho — **server-side** (§3.7), porque
 * ordenar só a página corrente mentiria com paginação. Busca e `mat-paginator` permanecem.
 *
...
export class Clientes implements OnInit {
  ...
  // --- Ajuste 8 (T-M6-08b): ordenação server-side (§3.7/§3.11) ---
  //
  ...
  // da capacidade de SERVIÇO do §3.7, que fica em `ClientesService`/`ContatoConsulta` com
